...
class Course:
    ...
    def location(self):
        # A method that prints the head office location
...
class OOPCourse(Course):
    ...
    # Create a constructor that intialises the following attributes and assigns these values
    def __init__(self,description = "OOP Fundamentals",trainer = "Mr Anon A. Mouse"):
        self.description = description
        self.trainer = trainer

    # create a method named "trainer_details" that prints what the course about and the name of the trainer by using the description and trainer attributes.
    def trainer_details(self):
        print(f"This course is covers: {self.description}\nThe trainer is: {self.trainer}")

    # create a method called "show_course_id" that prints the ID number of the course #12345
    def show_course_id(self):
        print("ID number of the course: #12345")



# Create an object of the subclass called course_1 and call the following methods
course_1 = OOPCourse()
